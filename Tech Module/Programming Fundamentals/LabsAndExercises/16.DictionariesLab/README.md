...
|Input	                                                |Output                 |
|:---                                                   |:---                   |
|In SoftUni you can study Java, C#, PHP and JavaScript. |2-3, and, c#, can, go, |
|JAVA and c# developers graduate in 2-3 years. Go in!	|in, java, php, you     |
...
|---------------------------|---------------|---------------------|
|                           |               | 2  1  8  7  +       |
| 1 2 3 4 5 6 7 8           | 5 5 13 13	    | 3  4  5  6  =       |
|                           |               | 5  5 13 13          |
|---------------------------|---------------|---------------------|
|                           |               |-1  3  4 -2  7  6  + |
| 4 3 -1 2 5 0 1 9 8 6 7 -2 |1 8 4 -1 16 14 | 2  5  0  1  9  8  = |
|                           |               | 1  8  4 -1 16 14    |
