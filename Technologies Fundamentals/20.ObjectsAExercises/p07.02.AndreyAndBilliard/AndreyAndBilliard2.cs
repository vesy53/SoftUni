namespace p07._02.AndreyAndBilliard
{
    using System;
    using System.Linq;
    using System.Collections.Generic;

    class AndreyAndBilliard2
    {
        static void Main(string[] args)
        {
            Dictionary<string, decimal> menu = ReadMenu();

            List<Customer> customers = ReadCustomers(menu);

            PrintResult(menu, customers);
        }
        ...
        static List<Customer> ReadCustomers(Dictionary<string, decimal> menu)
        {
        ...
        static Dictionary<string, decimal> ReadMenu()
        {
