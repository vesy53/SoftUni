...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('SoftUniBlogBundle\\Form\\ArticleType' => function () {
    return ${($_ = isset($this->services['SoftUniBlogBundle\Form\ArticleType']) ? $this->services['SoftUniBlogBundle\Form\ArticleType'] : $this->services['SoftUniBlogBundle\Form\ArticleType'] = new \SoftUniBlogBundle\Form\ArticleType()) && false ?: '_'};
}, 'SoftUniBlogBundle\\Form\\UserType' => function () {
    return ${($_ = isset($this->services['SoftUniBlogBundle\Form\UserType']) ? $this->services['SoftUniBlogBundle\Form\UserType'] : $this->services['SoftUniBlogBundle\Form\UserType'] = new \SoftUniBlogBundle\Form\UserType()) && false ?: '_'};
