    ...
    class GreedyTimes
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < itemsInput.Length; i += 2)
            {
                ...
                bool canInsertItem = CanPutItemInBag(
                    itemType, itemAmount, bagCapacity, goldQuantity, gemQuantity, cashQuantity);
        ...
        private static string PrintBag(
        ...
        private static bool CanPutItemInBag(
            string itemType,
            long itemAmount,
            long bagCapacity,
            long goldQuantity,
